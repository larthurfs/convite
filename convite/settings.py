"""
Django settings for convite project.
...
SECRET_KEY = 'django-insecure-kr^8_(#*wbs^xmhth)i1k-wht^#(7hk8c81(985_p$1lmgl$j4'
...
WSGI_APPLICATION = 'convite.wsgi.application'
